...
Public Class frmAssessTestView
    Inherits frmMax
    ...
    Public Overrides Function PrepForm(oView As clsWinView, ByVal prepMode As EnumfrmMode, ByVal prepIdx As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Dim objModel As frmAssessTestViewModel = Me.InitData("frmAssessTestViewModel", oView, prepMode, prepIDX, strXML)
    ...
    Protected Friend Function GetNextTestQuestionID(ExistingTestQuestionID As Integer) As clsProcOutput
        ...
        Params.Add(New clsSQLParam("@AssessTestID", myUtils.cValTN(myRow("AssessTestID")), GetType(Integer), True))
