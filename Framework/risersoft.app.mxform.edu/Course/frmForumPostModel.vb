...
<DataContract>
Public Class frmForumPostModel
    ...
    Public Overrides Function PrepForm(oView As clsViewModel, ByVal prepMode As EnumfrmMode, ByVal prepIDX As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Me.ClientParams.Add(New clsSQLParam("myuserid", myContext.Police.UniqueUserID.ToString, GetType(Guid), False))
    ...
    Public Overrides Function VSave() As Boolean
        ...
        If Me.Validate Then
            ...
            If frmMode = EnumfrmMode.acEditM Then
                Dim sql As String = "select ForumPostID from ForumPost where dbo.fncWorkItemUser('" & myContext.Police.UniqueUserID & "', '00000000-0000-0000-0000-000000000000', ForumPost.CreatedByID, '00000000-0000-0000-0000-000000000000', CourseID, '00000000-0000-0000-0000-000000000000', NULL)= 1"
            ...
            If Me.CanSave Then
                Dim Sql As String = "select courseid, coursecode, coursename from course where courseid = " & myRow("courseid")
                Dim ds As DataSet = myContext.Provider.objSQLHelper.ExecuteDataset(CommandType.Text, Sql)
                Dim PostDescrip As String = " Post: " & myUtils.cStrTN(myRow("Title")) & " for: " & myUtils.cStrTN(ds.Tables(0).Rows(0)("coursecode")) & ", " & myUtils.cStrTN(ds.Tables(0).Rows(0)("coursename"))
                Try
