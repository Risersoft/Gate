...
<DataContract>
Public Class frmAssessTestViewModel
    ...
    Public Overrides Function PrepForm(oView As clsViewModel, ByVal prepMode As EnumfrmMode, ByVal prepIDX As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Me.InitData(sql, "AssessTestID,CourseID", oView, prepMode, prepIDX, strXML)

        Me.ClientParams.Add(New clsSQLParam("UserID", myContext.Police.UniqueUserID.ToString, GetType(Guid), False))
        ...
        If oRet.Success Then
            Select Case dataKey.Trim.ToLower
                Case "testquestion"
                    ...
                    Dim TestQuestionID = myEduFuncs.GetNextQuestionID(myContext, AssessUserID, myUtils.cValTN(nr("assessTestID")),
                                             myUtils.cValTN(nr("AssessSurveyID")),
